...
title('BueExports - Beispiel');

state(['exampleData' => [
    'name' => 'Beispiel Item',
    'description' => 'Dies ist ein Beispiel-Item für die BueExports App',
    'status' => 'active',
...
<x-intranet-app-bue-exports::bue-exports-layout heading="Beispiel-Seite" subheading="Demonstration der BueExports-Funktionalität">
    <flux:card>
